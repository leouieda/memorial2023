...
Este projeto Começou com o último trabalho da sementes (EGU 2014).
Inversão da Moho
...
\begin{displayquote}
    MELO, F. F.; BARBOSA, V. C. F.; UIEDA, L.; OLIVEIRA Jr, V. C.; SILVA, J. B.
    C.  A Single Euler Solution Per Anomaly. In: 76th EAGE Conference and
    Exhibition 2014.
\end{displayquote}
...
O objetivo da série de tutoriais é explicar conceitos de geofísica de forma
prática e acessível.
Um dos requisitos para a publicação é a inclusão de código fonte o qual o
leitor possa utilizar para explorar os conceitos abordados pelo tutorial.
...
Os 9 artigos da revista mais acessados nos últimos 12 meses são todos
pertencentes à série de tutoriais\footnote{Segundo
