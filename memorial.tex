...
\newcommand{\GitHub}[1]{\faGithub{} código \href{https://github.com/#1}{github.com/#1}}

% Add a link to a YouTube video
\newcommand{\YouTube}[1]{\faYoutube{} vídeo \href{https://www.youtube.com/watch?v=#1}{youtube.com/watch?v=#1}}
...
\newcommand{\prettyhref}[1]{\href{https://#1}{#1}}
...
\titleformat{\chapter}[display]{\normalfont}{\vspace{-3cm}\large Capítulo \thechapter}{1pt}{\vspace{-0.25cm}\huge}[\titlerule]
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações para contato]
  \begin{fa-ul}
    ...
    \faUser & Página pessoal: \prettyhref{www.leouieda.com} \\
    \faUsers & Grupo de pesquisa: \prettyhref{www.compgeolab.org}
  \end{fa-ul}
\end{summarybox}
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Portfólio de produção em ciência aberta]
  \begin{fa-ul}
    \faGithub & GitHub: \prettyhref{github.com/leouieda}
      (código, material didático) \\
    \aiFigshare & figshare: \prettyhref{figshare.com/authors/Leonardo\_Uieda/97471}
      (dados, apresentações, material suplementar) \\
    \aiImpactstory & Impactstory: \prettyhref{impactstory.org/u/0000-0001-6123-9515}
      (análise contextual da produção aberta) \\
    \faYoutube & YouTube: \prettyhref{youtube.com/LeonardoUieda}
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto]
  \begin{fa-ul}
    \faLink & Página principal: \prettyhref{tesseroids.leouieda.com}
    \\
    \faGithub & Código: \prettyhref{github.com/leouieda/tesseroids}
    \\
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto]
  \begin{fa-ul}
    \faLink & Página principal: \prettyhref{www.fatiando.org}
    \\
    \faGithub & Código: \prettyhref{github.com/fatiando}
    \\
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto GMT]
  \begin{fa-ul}
    \faLink & Página principal: \prettyhref{www.generic-mapping-tools.org}
    \\
    \faGithub & Código: \prettyhref{github.com/GenericMappingTools}
    \\
  ...
  \end{fa-ul}
\end{summarybox}
\footnotetext{Citações ao trabalho \citep{Wessel2019}.}
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto PyGMT]
  \begin{fa-ul}
    \faLink & Página principal: \prettyhref{www.pygmt.org}
    \\
    \faGithub & Código: \prettyhref{github.com/GenericMappingTools/pygmt}
    \\
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto]
  \begin{fa-ul}
    \faLink & Página principal: \prettyhref{compgeolab.org/xlandsat}
    \\
    \faGithub & Código: \prettyhref{github.com/compgeolab/xlandsat}
    \\
...
\begin{subsummarybox}[frametitle=\faInfoCircle{}\quad Recursos educacionais]
  Apostila, material de geofísica 1/2, material de Liverpool.
  \begin{paperlist}
  \end{paperlist}
\end{subsummarybox}
\begin{subsummarybox}[frametitle=\faInfoCircle{}\quad Vídeos]
  Transform. Baixar imagens do Landsat.
  \begin{paperlist}
  \end{paperlist}
\end{subsummarybox}
