...
Geofísica.
Além disso, me amigo e colega de turma
...
pessoas.
Minhas linhas de pesquisa e atividades de ensino e extensão serão discutidas
nos capítulos~\ref{cap_pesquisa}, \ref{cap_ensino} e \ref{cap_extensao},
respectivamente.
...
Tomei posse do cargo de Professor Assistente na \UERJ{} (UERJ) em Fevereiro de
2014 enquanto realizava meu Doutorado no Observatório Nacional.
Assumi a posição de coordenador do Laboratório de Geofísica de Exploração
(LAGEX) e fiquei responsável por duas novas disciplinas de geofísica do
