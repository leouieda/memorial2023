...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Resumo da linha de pesquisa]
  \begin{fa-ul}
    ...
    \faBullseye &
      Objetivos principais: Desenvolver métodos numéricos para calcular o campo
      gravitacional e suas derivadas espaciais causados por prismas esféricos
      (tesseroides) de maneira computacionalmente eficiente e acurada. Utilizar
      os métodos desenvolvidos para modelar estruturas geológicas em escala
      continental e global. Disponibilizar ferramentas de software livre que
      implementam os métodos para o uso da comunidade científica.
  \end{fa-ul}
\end{summarybox}
