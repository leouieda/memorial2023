...
meu mestrado, transformei o Fatiando a Terra em uma biblioteca escrita na
linguagem Python\footnote{O momento exato em que essa mudança aconteceu está
registrado no repositório do GitHub: \url{https://github.com/fatiando/fatiando/commit/928515b0fcfdccecbc4f661ed2469390ef43ec1d}}.
Meu novo objetivo era agregar todo o código que estava desenvolvendo para minha
dissertação e as disciplinas da pós-graduação.

A biblioteca \verb|fatiando| incluir funções para a modelagem direta e inversão de
diversos métodos geofísicos.
