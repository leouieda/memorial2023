...
era acolhedor e um ambiente agradável de se trabalhar.
...
Ministrei um total de sete disciplinas de graduação, incluindo trabalho campo
de geofísica, programação em Python, sensoriamento remoto e geodinâmica
...
Como coordenador, sou responsável pelo recrutamento de alunos, alocação de
professores para as disciplinas, revisão da estrutura do curso, revisão de
outros cursos da School of Environmental Sciences, organizar atividades para
os calouros, dar apoio aos alunos e lidar com casos administrativos como
transferências de curso, trancamento, etc.
...
Minha experiência em Liverpool tem sido gratificante e possibilitou meu
crescimento profissional na pesquisa, administração e extensão.
Porém, ter passado pelo período intenso de trabalho extra causado pela pandemia
de COVID e a mudança para aulas online me deixaram exausto.
...
aproximadamente 50 dias de aulas por semestre ao longo três anos (comparado com
aproximadamente 100 dias por semestre ao longo de quatro ou cinco anos na USP).
...
Brasil são a nível de pós-doutorado para alunos daqui.
Todos esses fatores tornaram difícil manter minha pesquisa tão ativa quanto
eu gostaria e minha produção diminuiu como consequência.
...
e extensão.
Seria uma honra ter a chance de fazer minha parte para elevar ainda mais os
alunos brasileiros e a Universidade de São Paulo.
