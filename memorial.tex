...
\mdfdefinestyle{summarybox}{%
  ...
  linewidth=3pt,%
  linecolor=lu_blue,%
  frametitlefont=\bfseries\color{lu_gray},%
...
\begin{summarybox}[frametitle=\faGraduationCap{}\quad Doutorado em Geofísica]
  \begin{fa-ul}
    ...
    \faTrophy & Ganhador do Prêmio SBGf de Melhor Tese de Doutorado (2015--2017)
  \end{fa-ul}
\end{summarybox}
...
\section{Atuação extra (nome melhor)}

\begin{summarybox}[frametitle=\faUniversity{}\quad Coisas a mais]
  Criar uma EntriesTable como do CV com data e a coisa.
  JOSS, EarthArXiv, Software Underground, pyOpenSci.
\end{summarybox}
