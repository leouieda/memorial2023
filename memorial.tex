...
\mdfdefinestyle{summarybox}{%
  ...
  linewidth=5pt,%
  linecolor=lu_blue,%
  frametitlefont=\bfseries\color{lu_gray}\large,%
  frametitlebackgroundcolor=lu_blue,
...
% Define something like an fa-ul
\NewEnviron{fa-ul}{%
  \vspace{-0.4cm}
  \begin{tabularx}{\linewidth}{@{}p{0.05\linewidth}@{\hspace{0.02\linewidth}}p{0.90\linewidth}@{}}
    \BODY
  \end{tabularx}%
}
...
\end{figure}
\begin{summarybox}[frametitle=\faUserGraduate{}\quad Doutorado em Geofísica]
  \begin{fa-ul}
  ...
  \end{fa-ul}
\end{summarybox}
\begin{summarybox}[frametitle=\faUserGraduate{}\quad Mestrado em Geofísica]
  \begin{fa-ul}
    \faUniversity & Observatório Nacional \\
...
\begin{summarybox}[frametitle=\faPlane{}\quad Intercâmbio Internacional]
  ...
  \end{fa-ul}
\end{summarybox}
\begin{summarybox}[frametitle=\faUserGraduate{}\quad Bacharelado em Geofísica]
  \begin{fa-ul}
...
\begin{figure}[h]
  \HeroFigPad
  \begin{center}
    \includegraphics[width=\textwidth]{images/scipy2014-sprints.jpg}
  \end{center}
  \caption{
    Colaboração sobre software livre na geociência durante as \textit{sprints}
    do evento \href{https://conference.scipy.org/scipy2014/}{Scipy 2014}.
  }
\end{figure}
